...
def process_woocommerce_csv():
    ...
    with open(file_path, mode='r', encoding='utf-8') as f:
        ...
        for row in reader:
            ...
            # 🚨 STRICT IMAGE VALIDATION: اگر امیج لنک خالی ہے یا اس میں 'http' نہیں ہے تو پراڈکٹ مکمل طور پر سکپ ہو جائے گی۔
    ...
    print(f"✔ کل {len(products_list)} درست تصویروں والی پروڈکٹس پراسیس ہو رہی ہیں...")
    ...
    # Shop by Category Section has been completely removed from here.
    ...
    for cat_name, prods in sections_dict.items():
        ...
        home_html += f"""
        <div class="mb-14 category-section mt-4">
    ...
    <script>
        ...
        document.getElementById('checkoutForm').addEventListener('submit', function(e) {{
            ...
            fetch('https://formspree.io/f/xjgnlgpw', {{
                ...
                if (response.ok) {{
                    if(!isBuyNow) localStorage.removeItem('asm_cart'); 
    ...
    print("🎉 پرفیکٹ! تمام مسائل حل کر دیے گئے ہیں اور ویب سائٹ مکمل طور پر ریڈی ہے۔")
