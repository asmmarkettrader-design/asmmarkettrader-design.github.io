...
def get_html_header(title, categories_list=[], seo_desc="ASM VEO - Premium Online Shopping in Pakistan",
    ...
    # 🌟 SEO FIX: Title and Desc Lengths 🌟
...
<body class="text-gray-900 dark:text-gray-100">
    ...
    <div class="bg-gray-900 text-white text-xs py-2 hidden md:block">
        <div class="container mx-auto px-4 flex justify-between items-center">
            ...
            <div class="flex gap-4 items-center">
                <button onclick="toggleDarkMode()" class="hover:text-[#E53935]" aria-label="Toggle Dark Mode"><i class="fas fa-moon dark-mode-icon" aria-hidden="true"></i></button>
    ...
    <header class="glass shadow-md sticky top-0 z-50 transition-colors border-b border-gray-100 dark:border-gray-800">
        <div class="bg-[#E53935] text-white text-xs md:text-sm py-2 md:hidden">
            <div class="container mx-auto px-4 flex justify-between items-center">
                <a href="/index.html" class="hover:text-gray-300 transition font-semibold"><i class="fas fa-home mr-1" aria-hidden="true"></i> Home</a>
                <button onclick="toggleMobileCats()" class="hover:text-gray-300 transition font-semibold focus:outline-none" aria-label="Toggle Mobile Categories"><i class="fas fa-list mr-1" aria-hidden="true"></i> Categories</button>
            </div>
        </div>
        ...
        <div class="container mx-auto px-4 py-3 flex flex-wrap justify-between items-center gap-4">
            <!-- 🌟 SEO FIX: Updated Logo to Png logo.jpg 🌟 -->
        ...
        <nav class="hidden md:block border-t border-gray-100 dark:border-gray-800">
            <div class="container mx-auto px-4 flex items-center gap-6">
                <div class="relative dropdown z-50">
                    <button class="bg-[#E53935] text-white px-4 py-2.5 font-bold text-sm flex items-center gap-2 hover:bg-[#C62828] transition-colors" aria-haspopup="true" aria-expanded="false"><i class="fas fa-list" aria-hidden="true"></i> All Categories <i class="fas fa-chevron-down text-[10px]" aria-hidden="true"></i></button>
                ...
                <div class="ml-auto text-xs font-bold text-gray-600 dark:text-gray-400"><i class="fas fa-phone mr-1 text-[#E53935]" aria-hidden="true"></i> 0342 54 786 83</div>
            </div>
        </nav>
    </header>
    ...
    <nav class="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-900 shadow-2xl border-t border-gray-100 dark:border-gray-800 flex justify-around py-2 md:hidden z-50">
        <a href="/index.html" class="flex flex-col items-center text-[#E53935] text-xs font-bold"><i class="fas fa-home text-lg mb-1" aria-hidden="true"></i> Home</a>
        <button onclick="toggleMobileCats()" class="flex flex-col items-center text-gray-500 dark:text-gray-400 text-xs font-bold" aria-label="Open Categories"><i class="fas fa-th-large text-lg mb-1" aria-hidden="true"></i> Categories</button>
    ...
    <div id="exitModal" class="hidden fixed inset-0 bg-black/70 z-[9999] items-center justify-center p-4">
        <div class="bg-white dark:bg-gray-800 rounded-3xl p-8 max-w-md w-full text-center relative slide-in">
            <button onclick="document.getElementById('exitModal').classList.add('hidden')" class="absolute top-4 right-4 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white" aria-label="Close Modal"><i class="fas fa-times text-xl" aria-hidden="true"></i></button>
    ...
    <div id="quickViewModal" class="hidden fixed inset-0 bg-black/70 z-[9999] items-center justify-center p-4">
        <div class="bg-white dark:bg-gray-800 rounded-3xl max-w-3xl w-full overflow-hidden relative slide-in flex flex-col md:flex-row">
            <button onclick="closeQuickView()" class="absolute top-4 right-4 bg-white/80 rounded-full p-2 text-gray-700 hover:bg-white z-10" aria-label="Close Quick View"><i class="fas fa-times text-xl" aria-hidden="true"></i></button>
            ...
            <div class="md:w-1/2 p-6 flex flex-col">
                ...
                <div class="mt-auto flex flex-col gap-2">
                    <button id="qvAddCart" class="w-full bg-[#E53935] text-white py-3 rounded-xl font-bold hover:bg-[#C62828] transition flex items-center justify-center gap-2"><i class="fas fa-cart-plus" aria-hidden="true"></i> Add to Cart</button>
                    <button id="qvBuyNow" class="w-full bg-gray-900 dark:bg-white text-white dark:text-gray-900 py-3 rounded-xl font-bold hover:bg-gray-800 dark:hover:bg-gray-100 transition flex items-center justify-center gap-2"><i class="fas fa-bolt" aria-hidden="true"></i> Buy Now</button>
                    <a id="qvLink" href="#" class="text-center text-sm text-[#E53935] hover:underline mt-2 font-semibold">View Full Details</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <footer class="bg-gray-50 dark:bg-gray-950 text-gray-800 dark:text-gray-200 mt-16 pt-12 pb-20 md:pb-8 border-t-4 border-[#E53935]">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-10 mb-10">
                ...
                <div>
                    <!-- 🌟 SEO FIX: Updated Logo to Png logo.jpg in footer 🌟 -->
...
# ==============================================================================
# PRODUCT CARD GENERATOR (🌟 SEO FIX: Larger Tap Targets, Better Text Size 🌟)
# ==============================================================================
...
def generate_static_pages(categories_list):
    ...
    pages = {
        ...
        # 🌟 NEW: BEAUTIFUL ORDER SUCCESS PAGE & GOOGLE REVIEWS OPT-IN 🌟
    ...
    faq_html += """<div class="container mx-auto px-4 py-16 max-w-3xl"><h1 class="text-4xl font-extrabold text-[#E53935] dark:text-white mb-8 text-center">Frequently Asked Questions</h1><div class="space-y-4">"""
    for q, a in faqs:
        faq_html += f"""<details class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 group"><summary class="p-5 cursor-pointer font-bold text-gray-900 dark:text-white flex justify-between items-center list-none" aria-expanded="false">{q}<i class="fas fa-chevron-down text-[#E53935] transition-transform group-open:rotate-180" aria-hidden="true"></i></summary><div class="px-5 pb-5 text-gray-600 dark:text-gray-300 text-sm leading-relaxed">{a}</div></details>"""
    faq_html += "</div></div>"
    ...
    with open("output/faq.html", "w", encoding="utf-8") as f: f.write(minify_html(faq_html))
...
def generate_sitemap(urls):
    ...
    xml_content += '</urlset>'
    with open("output/sitemap.xml", "w", encoding="utf-8") as f: f.write(xml_content)

def generate_robots_txt():
    content = "User-agent: *\nAllow: /\nDisallow: /checkout.html\n\nSitemap: https://www.asmveo.com/sitemap.xml\nSitemap: https://www.asmveo.com/image-sitemap.xml\n"
    with open("output/robots.txt", "w") as f: f.write(content)

def generate_manifest():
    manifest = {"name": "ASM VEO - Online Shopping in Pakistan", "short_name": "ASM VEO", "description": "Premium online shopping in Pakistan with Cash on Delivery", "start_url": "/index.html", "display": "standalone", "background_color": "#ffffff", "theme_color": "#E53935", "icons": [{"src": "/assets/icon-192.png", "sizes": "192x192", "type": "image/png"}, {"src": "/assets/icon-512.png", "sizes": "512x512", "type": "image/png"}]}
...
def generate_image_sitemap(products_list):
    ...
    xml_content += '</urlset>'
    with open("output/image-sitemap.xml", "w", encoding="utf-8") as f: f.write(xml_content)
...
def generate_merchant_feed(products_list):
    ...
    xml_content += '</channel>\n</rss>'
    with open("output/merchant-feed.xml", "w", encoding="utf-8") as f: f.write(xml_content)
...
def process_woocommerce_csv():
    ...
    for cat_name, prods in sections_dict.items():
        ...
        for page_num in range(1, total_pages + 1):
            ...
            <div class="container mx-auto px-4 pb-12"><div class="flex flex-col lg:flex-row gap-6 mt-8">
                ...
                <div class="flex-1"><div id="productGrid" class="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
            """
            for prod in current_prods: cat_html += generate_product_card(prod, lazy=True)
            cat_html += "</div>" + generate_pagination_html(page_num, total_pages, f"category/{cat_slug}") + "</div></div></div>"
    ...
    if len(valid_home_cats) < 2: # Fallback just in case
    ...
    for h_page in range(1, total_home_pages + 1):
        page_title = "ASM VEO - Premium Online Shopping in Pakistan" if h_page == 1 else f"Home - Page {h_page} - Premium Online Shopping in Pakistan"
        ...
        if h_page == 1:
            ...
            home_html += """<h1 class="sr-only">ASM VEO - Premium Online Shopping in Pakistan</h1>
            <div id="heroCarousel" class="relative w-full h-[200px] md:h-[350px] overflow-hidden shadow-sm border-b border-gray-200 dark:border-gray-800" aria-label="Featured Promotions Carousel">
                <div class="carousel-track h-full">
                    ...
                    <!-- Banner 2: Electronics / Appliances -->
                    ...
                    <div class="carousel-slide h-full relative" aria-hidden="true">
                        ...
                        <div class="relative z-10 h-full flex items-center p-6 md:p-16 text-white">
                            <div class="max-w-lg">
                                <span class="bg-white text-green-700 text-xs font-black px-3 py-1 rounded-full shadow-lg">14 AUGUST SPECIAL</span>
                ...
                <button onclick="prevSlide()" class="absolute left-2 top-1/2 -translate-y-1/2 bg-black/40 text-white w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center hover:bg-black/80 transition z-20" aria-label="Previous slide"><i class="fas fa-chevron-left text-sm md:text-base" aria-hidden="true"></i></button>
                <button onclick="nextSlide()" class="absolute right-2 top-1/2 -translate-y-1/2 bg-black/40 text-white w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center hover:bg-black/80 transition z-20" aria-label="Next slide"><i class="fas fa-chevron-right text-sm md:text-base" aria-hidden="true"></i></button>
            ...
            <script>
                ...
                slides.forEach((_, i) => { dotsContainer.innerHTML += `<button onclick="goToSlide(${i})" class="w-2.5 h-2.5 md:w-3 md:h-3 rounded-full bg-white/50 hover:bg-white transition focus:outline-none" aria-label="Go to slide ${i + 1}"></button>`; });
                ...
                function nextSlide() { slideIndex = (slideIndex + 1) % slides.length; updateCarousel(); } function prevSlide() { slideIndex = (slideIndex - 1 + slides.length) % slides.length; updateCarousel(); } function goToSlide(i) { slideIndex = i; updateCarousel(); }
                updateCarousel(); setInterval(nextSlide, 3500);
            </script>
        ...
        for cat_name, prods in all_categories_list[start_c:start_c + cats_per_home_page]:
            cat_slug = re.sub(r'[^a-z0-9]+', '-', cat_name.lower()).strip('-')
            # Only loop exactly 6 items here so the layout is rigidly perfect
    ...
    <div class="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="lg:w-1/2">
                <div class="bg-[#E53935] p-6 rounded-t-3xl text-white relative"><div class="absolute top-0 left-0 w-full h-1 bg-white rounded-t-3xl"></div><h2 class="text-2xl font-extrabold flex items-center gap-2"><i class="fas fa-map-marker-alt text-white" aria-hidden="true"></i> Shipping Details</h2><p class="text-gray-200 text-sm mt-1"><i class="fas fa-truck" aria-hidden="true"></i> Expected delivery: {delivery_date}</p></div>
    ...
    """
    with open("output/checkout.html", "w", encoding="utf-8") as f: f.write(minify_html(checkout_html + get_html_footer()))
