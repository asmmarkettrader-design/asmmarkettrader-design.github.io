...
def generate_static_pages(categories_list):
    ...
    pages = {
            ...
            <div class="container mx-auto px-4 py-16 max-w-4xl">
                ...
                <div class="grid md:grid-cols-2 gap-8 mb-12">
                    <div class="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700">
                        <div class="w-14 h-14 bg-gray-100 dark:bg-gray-700 rounded-2xl flex items-center justify-center mb-4">
                            <i class="fas fa-bullseye text-2xl text-[#E53935]"></i>
                        </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700">
                        <div class="w-14 h-14 bg-gray-100 dark:bg-gray-700 rounded-2xl flex items-center justify-center mb-4">
                            <i class="fas fa-eye text-2xl text-[#E53935]"></i>
                        </div>
                ...
                <div class="animated-bg text-white rounded-3xl p-8 md:p-12">
        ...
        "contact.html": ("Contact Us", """
            <div class="container mx-auto px-4 py-16 max-w-4xl">
                <h1 class="text-4xl font-extrabold text-[#E53935] dark:text-white mb-8 text-center">Contact Us</h1>
                <div class="grid md:grid-cols-2 gap-8">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-8 border border-gray-100 dark:border-gray-700">
                        ...
                        <ul class="text-gray-600 dark:text-gray-300 space-y-2">
                            <li class="flex justify-between"><span>Monday - Sunday</span><span class="font-bold">9AM - 11PM</span></li>
                        </ul>
                        <div class="mt-6 pt-6 border-t border-gray-100 dark:border-gray-700">
                            <p class="text-sm text-gray-600 dark:text-gray-400"><i class="fas fa-building mr-2 text-[#E53935]"></i> ASM Digital Solutions</p>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1"><i class="fas fa-user-tie mr-2 text-[#E53935]"></i> CEO: Ali Abbas</p>
                        </div>
                    </div>
                </div>
            </div>"""),
        ...
        "privacy.html": ("Privacy Policy", """
            <div class="container mx-auto px-4 py-16 max-w-4xl prose dark:prose-invert">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-8 md:p-12 border border-gray-100 dark:border-gray-700 space-y-6 text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                    ...
                    <p>We collect your name, phone number, email, and shipping address when you place an order.</p>
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white">Data Security</h2>
                    <p>We use SSL encryption to protect your data. We never share your personal information with third parties except for shipping purposes.</p>
                </div>
            </div>"""),
        ...
        "terms.html": ("Terms & Conditions", """
            <div class="container mx-auto px-4 py-16 max-w-4xl">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-8 md:p-12 border border-gray-100 dark:border-gray-700 space-y-6 text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                    ...
                    <p>All orders are subject to availability. We accept Cash on Delivery (COD) only.</p>
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white">2. Delivery</h2>
                    <p>We deliver nationwide within 2-4 business days.</p>
                </div>
            </div>"""),
        ...
        "404.html": ("Page Not Found", """
            <div class="container mx-auto px-4 py-20 text-center">
                <div class="max-w-lg mx-auto">
                    ...
                    <a href="/index.html" class="inline-block bg-[#E53935] text-white px-8 py-3 rounded-xl font-bold hover:bg-[#C62828] transition shadow-lg"><i class="fas fa-home mr-2"></i> Go Home</a>
                </div>
            </div>"""),
        ...
        "wishlist.html": ("My Wishlist", """
            <div class="container mx-auto px-4 py-12">
                <h1 class="text-3xl font-extrabold text-[#E53935] dark:text-white mb-8 flex items-center gap-3">
                    <i class="fas fa-heart text-pink-500"></i> My Wishlist
                </h1>
                <div id="wishlistContainer" class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-4"></div>
            </div>
            <script>
            function renderWishlist() {
                ...
                if (wl.length === 0) { 
                    container.innerHTML = '<div class="col-span-full text-center py-16 text-gray-500 dark:text-gray-400"><i class="fas fa-heart-broken text-6xl mb-4 opacity-30"></i><p class="text-lg font-bold">Your wishlist is empty</p></div>'; 
                    return; 
                }
...
def process_woocommerce_csv():
        ...
        if i + 1 < len(products_list):
            ...
            <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-lg border border-gray-200 dark:border-gray-700 p-8 mb-16 md:mb-0 reveal">
                ...
                <div class="flex items-center gap-4">
                    <img src="{next_prod['image']}" alt="{next_prod['name'].replace('"', '&quot;')}" class="w-20 h-20 object-contain rounded-lg border border-gray-100" loading="lazy" decoding="async">
                    <div class="flex-grow">
                    ...
                    <a href="/product/{next_prod['slug']}.html" class="bg-[#E53935] text-white py-3 px-6 rounded-xl font-bold hover:bg-[#C62828] transition flex items-center gap-2 whitespace-nowrap">Next <i class="fas fa-arrow-right" aria-hidden="true"></i></a>
                </div>
            </div>"""
            ...
            <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden flex flex-col md:flex-row mb-12 reveal">
                ...
                <div class="md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 w-full md:w-5/6 mt-auto main-product-actions">
                        ...
                        <button onclick="buyNow('{escaped_name}', {prod['final_price']}, '{prod['image']}', event)" aria-label="Buy Now" class="sm:w-1/2 bg-[#E53935] text-white py-4 rounded-xl font-black text-lg hover:bg-[#C62828] transition-all shadow-lg flex justify-center items-center gap-2">
                    ...
                    return `<div class="product-card reveal active bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-md border border-gray-200 dark:border-gray-700 overflow-hidden flex flex-col relative cursor-pointer" onclick="window.location.href='/product/${p.slug}.html'">
                        ...
                        <div class="p-3 flex flex-col flex-grow">
                            ...
                            <div class="mt-auto">
                                ...
                                <button onclick="addToCart('${jsSafeName}', ${p.final_price}, '${p.image}', event)" class="w-full bg-gray-50 text-[#E53935] py-2.5 rounded-lg text-xs font-bold border border-gray-200 hover:bg-[#E53935] hover:text-white transition flex justify-center items-center"><i class="fas fa-cart-plus"></i> Add to Cart</button>
                            </div>
                        </div>
                    </div>`; 
                } 
    ...
    if len(valid_home_cats) < 2: # Fallback just in case there are very few items
    ...
    for h_page in range(1, total_home_pages + 1):
        ...
        for cat_name, prods in all_categories_list[start_c:start_c + cats_per_home_page]:
            ...
            # 🌟 GUARANTEE EXACTLY 6 ITEMS HERE 🌟
            home_html += f"""
