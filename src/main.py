...
# ================= CATEGORY PAGES =================
    ...
    for cat_name, prods in sections_dict.items():
        ...
        subnav_html = ''.join(
            f'<a href="/category/{safe_filename(cat_name)}/{safe_filename(sub)}/" class="flex flex-col items-center min-w-24 p-2 rounded-xl border bg-white dark:bg-gray-800 hover:border-[#087443]">'
        ...
        if h_page == 1:
            ...
            <div class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 py-6">
                <div class="container mx-auto px-4">
                    <div class="grid grid-cols-4 md:grid-cols-7 gap-4 md:gap-6 text-center">
            """
            ...
            for cat in unique_top_cats:
                ...
                rep = next((p for p in products_list if p.get("image") and any(w in " ".join([str(p.get("name","")),str(p.get("category","")),str(p.get("subcategory",""))]).lower() for w in words)), None)
                cat_img = rep.get("image") if rep else "/icon.png"
            ...
            if flash_items:
                ...
                <section class="flash-sale-section" aria-label="Flash Sale">
                    <div class="container mx-auto px-4">
                        <div class="flash-sale-heading">
                            <div>
                                <h2>⚡ Flash Sale</h2>
                                <p>Top picks from our main categories</p>
                            </div>
                ...
                <style>
                    ...
                    .flash-sale-heading span{font-size:10px;font-weight:900;letter-spacing:1.2px;color:#087443;border:1px solid #fecaca;border-radius:999px;padding:6px 9px}
                    ...
                    .flash-ring-price{margin-top:3px;font-size:11px;line-height:13px;font-weight:900;color:#087443;white-space:nowrap}
                ...
                <form id="checkoutForm" class="bg-white dark:bg-gray-800 p-6 md:p-8 rounded-b-3xl shadow-xl border border-gray-200 dark:border-gray-700 border-t-0 space-y-5">
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <input type="text" id="couponCode" placeholder="Enter ASM10 for 10% off (Min Rs 3000)" class="w-full border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white p-3 rounded-xl bg-gray-50 focus:bg-white focus:border-[#087443] outline-none uppercase">
